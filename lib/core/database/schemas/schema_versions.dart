...
// FORK NOTE: the imports below are hand-added and NOT emitted by drift_dev.
// Table defaults in the schema snapshots reference project code (AppConstants,
// enums, default models, jsonEncode), so regenerating this file with
// `drift_dev schema steps` strips them and breaks the build. Re-add them after
// any regeneration. See docs/FORK.md.
import 'dart:convert';
...
final class Schema10 extends i0.VersionedSchema {
  ...
  late final Shape27 appRestrictionTable = Shape27(
      source: i0.VersionedTable(
        entityName: 'app_restriction_table',
        withoutRowId: false,
        isStrict: false,
...
class Shape27 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get reminderType =>
      columnsByName['reminder_type']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get cooldownBreathSec =>
      columnsByName['cooldown_breath_sec']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<int> get cooldownWindowSec =>
      columnsByName['cooldown_window_sec']! as i1.GeneratedColumn<int>;
}

i1.GeneratedColumn<int> _column_93(String aliasedName) =>
    i1.GeneratedColumn<int>('cooldown_breath_sec', aliasedName, false,
        type: i1.DriftSqlType.int, defaultValue: const Constant(0));
i1.GeneratedColumn<int> _column_94(String aliasedName) =>
    i1.GeneratedColumn<int>('cooldown_window_sec', aliasedName, false,
        type: i1.DriftSqlType.int, defaultValue: const Constant(120));
